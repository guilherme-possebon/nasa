...
export default function NeoSelect({ value, onChange, disabled }: Props) {
    ...
    return (
        <div className="mb-4">
            <label className="block text-sm font-medium text-gray-100 mb-1">Celestial Body</label>
            ...
            <p className="mt-1 text-xs text-gray-300">
                When selecting a celestial body, the diameter and velocity are filled in
                automatically.
            </p>
        </div>
    );
